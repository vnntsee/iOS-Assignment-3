...
class Habit: Identifiable {
    ...
    var index: Int //Position in user's habits list: between 0 to last index.
    var name: String
    ...
    init(name: String = "", daysToComplete: [String] = [], priority: Int = 3, dateCreated: Date = .now, isCompleted: Bool = false, index: Int = -1) {
        self.name = name
